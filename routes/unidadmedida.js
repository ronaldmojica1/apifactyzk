...
const UnidadMedidaController_1 = __importDefault(require("../controllers/inventario/UnidadMedidaController"));
...
router.delete('/:id', session_1.checkJwt, UnidadMedidaController_1.default.deleteR);
