...
const UnidadMedidaHController_1 = __importDefault(require("../controllers/inventario/UnidadMedidaHController"));
const session_1 = require("../middleware/session");
const router = (0, express_1.Router)();
exports.router = router;
router.get('/', session_1.checkJwt, UnidadMedidaHController_1.default.getAllR);
router.get('/:id', session_1.checkJwt, UnidadMedidaHController_1.default.getR);
