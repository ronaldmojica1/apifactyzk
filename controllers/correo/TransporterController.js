...
function updateR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let act = yield Transporter_1.default.findByPk(1); //Solo debe de haber un Transporter
            if (!act) {
                act = yield Transporter_1.default.create(req.body);
            }
            else {
...
function getR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const act = yield Transporter_1.default.findByPk(1);
            if (!act) {
