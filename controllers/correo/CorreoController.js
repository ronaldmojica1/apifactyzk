...
function updateR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let act = yield Correo_1.default.findByPk(1); //Solo debe de haber un Correo
            if (!act) {
                act = yield Correo_1.default.create(req.body);
            }
            else {
...
function getR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const act = yield Correo_1.default.findByPk(1);
            if (!act) {
