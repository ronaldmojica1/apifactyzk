...
function getAllR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const whereOptions = {};
            if (seccion) {
                whereOptions.seccion = seccion;
            }
            const acts = yield Tributo_1.default.findAll({
                where: whereOptions
            });
...
function createR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const act = yield Tributo_1.default.create(req.body);
...
function updateR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const act = yield Tributo_1.default.findByPk(req.params.id);
            if (!act) {
