...
function getAllR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const acts = yield PermisoRol_1.default.findAll({
                where: {
                    rolId: rolId
                }
            });
...
function createR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const act = yield PermisoRol_1.default.create(req.body);
...
function updateR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const act = yield PermisoRol_1.default.findByPk(req.params.id);
            if (!act) {
