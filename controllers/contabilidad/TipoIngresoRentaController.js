...
function getAllR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const ingresos = yield TipoIngresoRenta_1.default.findAll();
            res.status(201).json((0, apiresponse_1.successResponse)(ingresos, ''));
        }
        catch (error) {
...
function createR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const ingreso = yield TipoIngresoRenta_1.default.create(req.body);
            res.status(201).json((0, apiresponse_1.successResponse)(ingreso, 'Creado con exito!'));
        }
        catch (error) {
...
function updateR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const ingreso = yield TipoIngresoRenta_1.default.findByPk(req.params.id);
            if (!ingreso) {
                res.status(200).json((0, apiresponse_1.notFoundResponse)('No encontrado'));
                return;
            }
            yield ingreso.update(req.body);
            res.json((0, apiresponse_1.successResponse)(ingreso, 'Actualizado con exito'));
        }
        catch (error) {
...
function deleteR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            res.json((0, apiresponse_1.successResponse)(ingreso, 'Eliminado con exito!'));
        }
        catch (error) {
...
function getR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            //Ver
            res.json((0, apiresponse_1.successResponse)(ingreso, ''));
        }
        catch (error) {
