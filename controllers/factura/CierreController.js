...
function updateR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let act = yield Cierre_1.default.findByPk(1); //Solo debe de haber un cierre
            if (!act) {
                act = yield Cierre_1.default.create(req.body);
            }
            else {
...
function getR(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const act = yield Cierre_1.default.findByPk(1);
            if (!act) {
